    ...
    projects: [
      {
        ...
        description: 'Co-founded a research lab designing and building a low-cost, small-form-factor next-generation LEO black hole observation satellite to extend VLBI baselines and enable high time-resolution celestial imaging. Finalist in the NASA NIAC Innovative Technology Development Program. Led spacecraft bus, radio antenna, and receiver modeling and simulation; designed a 100 Gbps laser data downlink for high-volume VLBI observations and presented the architecture to MIT Lincoln Laboratory, initiating preliminary discussions for a TBIRD-derived downlink system. Simulated radio receiver thermal performance for 86–150 GHz deep-space observation; integrated a 15 K cryocooler (under NDA) into the T-REX Blue Canyon OTS bus. Optimized antenna diameter and surface RMS error versus cost to minimize integration time for black hole, AGN, and pulsar targets, and organized an independent study on antenna dynamics and construction. Coordinated cross-institutional research, including quantum-entangled data transfer development with the University of Australia, spacecraft design with researchers from Princeton University and Jet Propulsion Laboratory, and black hole observation campaign planning with Space Telescope Science Institute.',
      ...
      },
      {
        ...
        description: 'Elected Head of R&D, responsible for designing and manufacturing a 2 kg high-altitude weather balloon payload reaching 115,000 ft as a near-space component testing platform for solar panels, sensors, and deployable arms supporting BSE’s PVDX CubeSat mission scheduled for launch in Q2 2026. Designed and constructed challenge and testing environments to validate undercarriage assemblies, wheel performance, and future mission use cases for a scale rover modeled after the NASA Curiosity Rover developed and programmed by the BSE robotics team. Led onboarding and technical training for new members, teaching core engineering skills including CAD, Python, 3D printing, and laser cutting.',
      ...
      },
      {
        ...
        description: 'Modeled thermal performance across multiple combustion chamber, coolant loop, and housing configurations; machined and welded a dual-barrel combustion chamber and fabricated steel 3D-printed flanges, and designed and installed an oil cooling loop through the turbocharger. Conducted engine stress testing to identify overheating and turbo freeze failure points, achieving full self-sustaining combustion using propane and air. Led the complete lifecycle from initial research and CAD design through manufacturing, assembly, and testing within a six-month timeline.',
